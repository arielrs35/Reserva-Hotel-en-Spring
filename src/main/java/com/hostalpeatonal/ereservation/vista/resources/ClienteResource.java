 ...
 * 
 */
package com.hostalpeatonal.ereservation.vista.resources;
...
import com.hostalpeatonal.ereservation.negocio.services.ClienteService;
import com.hostalpeatonal.ereservation.vista.resources.vo.ClienteVO;
...
public class ClienteResource {
	...
	@ApiResponses(value = { @ApiResponse(code = 201, message = "cliente creado correctamente"),
			@ApiResponse(code = 400, message = "Solicitur Inválida") })
